...
export const SUPABASE_TABLE_CATALOG: SupabaseTableRow[] = [
  ...
  { schema: 'public', name: 'question_bank_neet', purpose: 'Primary NEET-style question bank; keyed by chapter. Optional prompt_set_id → kb_prompt_sets when generated with cloud prompt set.' },
