-- Repair sync for projects where 20260410120000 was never applied on the remote DB.
-- Fixes: "Invalid role: reviewer" on admin_set_user_role, 404 on upsert_question_bank_review_mark.
